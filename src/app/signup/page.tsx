...
export default function SignUP() {
  const { register, handleSubmit, formState: { errors }, watch } = useForm<types_set_user_signin>()
  ...
  return (
    ...
    >
      ...
      <div className="w-full">
        ...
        />
        {errors.city && (
          <p role="alert" className="text-red-500 text-sm mt-1">{errors.city.message}</p>
        )}
      </div>
      ...
      <div className="w-full">
        ...
        {errors.repeat_password && (
          <p role="alert" className="text-red-500 text-sm mt-1">{errors.repeat_password.message}</p>
        )}
      </div>
